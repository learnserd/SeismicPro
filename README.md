...
|[First-break picking](models/First_break_picking/1d_CNN/model_description.ipynb)| U-Net 1D | Datasets 1, 2 for FB picking <br/> | 0.06 MAE for dataset 1 <br/> 0.7 MAE for dataset 2
|[First-break picking](models/First_break_picking/Coppen's_unsupervised_method/model_description.ipynb)| Coppen's analytical method | Datasets 1, 2, 3 for FB picking | 7.57 MAE for dataset 1 <br/> 7.19 MAE for dataset 1 <br/> 12.6 MAE for dataset 3
